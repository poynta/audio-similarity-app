#!/usr/bin/env python3
"""
audio_web_tabs.py — Local browser-based Audio Similarity app
Two tabs: Index Folder | Query Audio (upload + indexed track)
"""

import os, tempfile, subprocess, pickle, hashlib
...
with gr.Blocks(title="Audio Similarity (CLAP + FAISS)") as demo:
    ...
    index_btn.click(do_index, inputs=folder_in, outputs=index_out)
